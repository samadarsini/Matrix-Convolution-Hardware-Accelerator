...
/*
 * Macros for device 'matrix_convolution_avalon_interface_0', class 'matrix_convolution_avalon_interface'
 * The macros are prefixed with 'MATRIX_CONVOLUTION_AVALON_INTERFACE_0_'.
 * The prefix is the slave descriptor.
 */
#define MATRIX_CONVOLUTION_AVALON_INTERFACE_0_COMPONENT_TYPE matrix_convolution_avalon_interface
#define MATRIX_CONVOLUTION_AVALON_INTERFACE_0_COMPONENT_NAME matrix_convolution_avalon_interface_0
#define MATRIX_CONVOLUTION_AVALON_INTERFACE_0_BASE 0x400
#define MATRIX_CONVOLUTION_AVALON_INTERFACE_0_SPAN 1024
#define MATRIX_CONVOLUTION_AVALON_INTERFACE_0_END 0x7ff
...
#define SYSID_QSYS_TIMESTAMP 1734150426
